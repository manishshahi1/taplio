...
generate_head_tags('Dashboard', $metatags, [], ['Inter:wght@100..900']);
?>
<!--begin::App-->
                    ...
                    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
                        ...
                        <div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
                                    ...
                                    <div class="menu menu-rounded menu-column menu-lg-row menu-active-bg menu-title-gray-600 menu-state-gray-900 menu-arrow-gray-500 fw-semibold fw-semibold fs-6 align-items-stretch my-5 my-lg-0 px-2 px-lg-0" id="#kt_app_header_menu" data-kt-menu="true">
                                        ...
                                        <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-placement="bottom-start" class="menu-item menu-lg-down-accordion menu-sub-lg-down-indention me-0 me-lg-2">
                                            ...
                                            <div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown px-lg-2 py-lg-4 w-lg-200px">
                                                ...
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link" href="#!" data-bs-toggle="modal" data-bs-target="#kt_modal_1">
                                                        <span class="menu-icon">
                                                            <i class="ki-outline ki-plus-square"></i>
                                                        </span> Create Team
                                                    </a>
                                                </div>
                                                <div class="menu-item">
                                                    <!--begin:Menu link-->
                                                    <a class="menu-link" href="#!" data-bs-toggle="modal" data-bs-target="#kt_modal_2">
                                                        <span class="menu-icon">
                                                            <i class="ki-outline ki-plus-square"></i>
                            ...
                            <div class="app-navbar flex-shrink-0">
                                ...
                                <a href="#" onclick="logout(); return false;" class="btn btn-sm btn-flex btn-primary align-self-center ms-5 ms-lg-11 px-3">Log out</a>
                            ...
                            <div class="app-sidebar-nav flex-grow-1 hover-scroll-y scroll-ms px-4 pt-2" id="kt_app_sidebar_primary_nav" data-kt-scroll="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_header, #kt_app_sidebar_primary_header, #kt_app_sidebar_primary_footer" data-kt-scroll-wrappers="#kt_app_content, #kt_app_sidebar_primary_nav" data-kt-scroll-offset="5px">
                                ...
                                <ul class="nav">
                                    ...
                                    <li class="nav-item py-1">
                                        <!--begin::Navbar link-->
                                        <a data-bs-toggle="tab" href="#kt_app_sidebar_secondary_collections" class="nav-link py-4 px-1 btn">
                                            <!-- <i class="ki-outline ki-questionnaire-tablet fs-1"></i> -->
                                            <img src="https://ui-avatars.com/api/?background=random&name=content-team" class="img-fluid rounded-3">
                                            <span class=" pt-2 fs-9 fs-lg-7 fw-bold">Content Team</span>
                                        </a>
                                        <!--end::Navbar link-->
                                    </li>
                                    <!--end::Navbar item-->
                                    ...
                                    <li class="nav-item py-1">
                                        ...
                                        <a data-bs-toggle="tab" href="#kt_app_sidebar_secondary_collections" class="nav-link py-4 px-1 btn active">
                                            <i class="ki-outline ki-questionnaire-tablet fs-1"></i>
                                            <span class="pt-2 fs-9 fs-lg-7 fw-bold">Engagment</span>
                                        </a>
                                        <!--end::Navbar link-->
                                    </li>
                                    <!--end::Navbar item-->
                            ...
                            <div id="kt_app_sidebar_secondary_wrapper" class="hover-scroll-y mx-3" data-kt-scroll="true" data-kt-scroll-activate="{default: true, lg: true}" data-kt-scroll-height="auto" data-kt-scroll-dependecies="#kt_app_header" data-kt-scroll-wrappers="#kt_app_content" data-kt-scroll-offset="5px">
                                ...
                                <div class="tab-content px-5 px-lg-6">
                                    ...
                                    <div class="tab-pane fade show active" id="kt_app_sidebar_secondary_collections" role="tabpanel">
                                        <!--begin::Collections-->
                                        <div class="card card-reset text-align-left card-p-0">
                                            <!--begin::Header-->
                                            ...
                                            <div class="card-body text-center">
                                                <p class="card-text">Manish Shahi (mshahi.biz@gmail.com)</p>
                                            </div>
                                            <!--end::Body-->
                                        </div>
                                        <!--end::Collections-->
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="d-flex align-items-center me-3">
                                                        <!--begin::Icon-->
                                                        <img src="assets/media/stock/ecommerce/14.png" class="me-4 w-50px ms-n3" alt="" />
                                                        <!--end::Icon-->
                                                        <!--begin::Section-->
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="d-flex align-items-center me-3">
                                                        <!--begin::Icon-->
                                                        <img src="assets/media/stock/ecommerce/13.png" class="me-4 w-50px ms-n3" alt="" />
                                                        <!--end::Icon-->
                                                        <!--begin::Section-->
                                                        <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="d-flex align-items-center me-3">
                                                        <!--begin::Icon-->
                                                        <img src="assets/media/stock/ecommerce/41.png" class="me-4 w-50px ms-n3" alt="" />
                                                        <!--end::Icon-->
                                                        <!--begin::Section-->
                                                        <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="d-flex align-items-center me-3">
                                                        <!--begin::Icon-->
                                                        <img src="assets/media/stock/ecommerce/53.png" class="me-4 w-50px ms-n3" alt="" />
                                                        <!--end::Icon-->
                                                        <!--begin::Section-->
                                                        <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="d-flex align-items-center me-3">
                                                        <!--begin::Icon-->
                                                        <img src="assets/media/stock/ecommerce/71.png" class="me-4 w-50px ms-n3" alt="" />
                                                        <!--end::Icon-->
                                                        <!--begin::Section-->
                                                        <div class="flex-grow-1">
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="d-flex align-items-center me-3">
                                                        <!--begin::Icon-->
                                                        <img src="assets/media/stock/ecommerce/194.png" class="me-4 w-50px ms-n3" alt="" />
                                                        <!--end::Icon-->
                                                        <!--begin::Section-->
                                                        <div class="flex-grow-1">
                                            ...
                                            <div class="card-body d-flex flex-column flex-center">
                                                ...
                                                <div class="mb-2">
                                                    ...
                                                    <h1 class="fw-semibold text-gray-800 text-center lh-lg">Have you tried new
                                                        <span class="fw-bolder">Notifications</span>
                                                    </h1>
                                                    <!--end::Title-->
                                                    <!--begin::Illustration-->
                                                    <div class="py-10 text-center">
                                                        <img src="assets/media/svg/illustrations/easy/1.svg" class="theme-light-show w-200px" alt="" />
                                                        <img src="assets/media/svg/illustrations/easy/1-dark.svg" class="theme-dark-show w-200" alt="" />
                                                    </div>
                                                    <!--end::Illustration-->
                                                </div>
                                                <!--end::Heading-->
                                    ...
                                    <div class="row gy-5 g-xl-10">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="row">
                                                ...
                                                // Select MongoDB collection for posts
                                                $postsCollection = selectCollection($db, 'posts');

                                                // Read posts from the collection
                                                $posts = readManyDocuments($postsCollection);
                                                // Loop through the posts
                                                foreach ($posts as $post) {
                                                    if ($post['content']) {
                                                ?>
                                                        <div class="col-12 col-sm-12 col-lg-3 col-xxl-3">
                                                            <div class="card my-3">
                                                                <div class="card-header">

                                                                    <h3 class="card-title"><?= $post['profile_name']; ?></h3>
                                                                    <h6 class="card-subtitle text-muted"><?= $post['profile_description']; ?></h6>
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <!-- donot remove below -->
                                                                    <?php
                                                                    // Replace the specified portion of text in the content
                                                                    $content = $post['content'];

                                                                    // Regular expression pattern to match the line starting with "Feed" and ending with "Follow"
                                                                    $patterns = [
                                                                        '/Feed.*Follow/s', // Pattern to match the line starting with "Feed" and ending with "Follow"
                                                                        '/…see more.*Send/s',           // Pattern to match "…see more"
                                                                        '/^\d+\s+Like\s+Comment\s+Repost\s+Send\s*$/m',  // Pattern to match any line ending with "Like Comment Repost Send" with any number at the start
                                                                        '/Activate.*?Send/s',
                                                                        '/(Activate to view larger image,)+/' // Pattern to match multiple occurrences of "Activate to view larger image,"
                                                                    ...
                                                                    // Remove the line
                                                                    $modified_content = preg_replace($patterns, '', $content);

                                                                    // Output the modified content
                                                                    echo '<p class="card-text">' . $modified_content . '</p>';

                                                                    if ($post['image_url']) {
                                                                        echo '<img src="' . $post['image_url'] . '" class="img-fluid mt-2 border p-2 rounded-3">';
                                                                    } elseif ($post['video_url']) {
                                                                        echo '
                                                                        <div class="embed-responsive embed-responsive-16by9">
                                                                            <video class="embed-responsive-item mt-2" controls>
                                                                ...
                                                                <div class="card-footer">
                                                                    ...
                                                                    <h4><b>Comments</b></h4>
                                                                    <p class="card-text"><b>Manish Shahi</b> <span class="text-muted">wrote a comment</span><span class="float-end">6 minutes ago</span></p>
                                                                    <p class="card-text">Great post...</p>
                                                                    <p class="card-text"><img src="https://letsenhance.io/static/8f5e523ee6b2479e26ecc91b9c25261e/1015f/MainAfter.jpg" alt="" class="img-fluid rounded-3 border border-light"></p>
                                                                    <hr>
                                                                    <p class="card-text"><b>Manish Shahi</b> <span class="text-muted">wrote a comment</span><span class="float-end">22 minutes ago</span></p>
                                                                    <p class="card-text">testing comment...</p>

                                                                    <!-- comments -->
                                                                    <form id="commentForm" class="mb-2">
                                                                        <label for="comment" class="form-label">Write a comment:</label>
                                                                        <textarea class="form-control" id="comment" name="comment"></textarea>
                                                                        <!-- button to upload image, schedule comment and generate with AI -->
                                                                        <div class="btn-group btn-group-sm my-2" role="group" aria-label="Basic example">
                                                                            <button type="button" class="btn btn-secondary"><i class="ki-outline ki-picture"></i>
                                                                            </button>
                                                                            <button type="button" class="btn btn-secondary"><i class="ki-outline ki-timer"></i></button>
                                                                            <button type="button" class="btn btn-secondary"><i class="ki-outline ki-pencil"></i></button>
                                                                        </div>
                                                                        <!-- END -->
                                                                        <p><button type="submit" id="commentFormBtn" class="btn btn-primary btn-sm my-3">Post</button>
                                                                            <button id="closeCommentFormBtn" class="btn btn-dark btn-sm ms-1">Close</button>
                                                                        </p>
                                                                    </form>
                                                                    <p class="card-text">
                                                                        ...
                                                                        <button type="button" data-post-id=" <?= $post['_id']; ?>" class="btn btn-light m-1 btn-sm like-button"><i class="ki-outline ki-like"></i> Like</button>
                                                                        <button type="button" data-post-id=" <?= $post['_id']; ?>" class="btn btn-light m-1 btn-sm"><i class="ki-outline ki-message-text"></i> Comment</button>
                                                                        <button type="button" class="btn btn-light m-1 btn-sm"> <i class="ki-outline ki-save-2"></i> Save</button>
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="createTeam">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="teamName" placeholder="Enter a team name">
                    </div>
                    <div class="mb-3">
                        <label for="teamDescription" class="form-label">Team Description</label>
                        <textarea class="form-control" id="teamDescription" placeholder="Write a description for your team."></textarea>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" id="createTeamBtn" class="btn btn-light" data-bs-dismiss="modal">Close</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="createTeam">
                    <div class="mb-3">
                        <label for="memberEmail" class="form-label">Team member's email address</label>
                        <input type="text" class="form-control" id="memberEmail" placeholder="Enter a team member's email address">
                    </div>
                    <button type="submit" class="btn btn-success">Search</button>
                </form>
                <!--begin::Alert-->
                <div class="alert alert-primary d-flex align-items-center p-5  mt-4">
                    <!--begin::Icon-->
                    ...
                    <div class="d-flex flex-column">
                        <!--begin::Title-->
                        <h4 class="mb-1 text-success">mshahi.biz@gmail.com (Manish Shahi) found.</h4>
                        <!--end::Title-->

                        <!--begin::Content-->
                        <a href="!#" class="btn btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_3">Add member</a>
                        <!--end::Content-->
                    </div>
                    <!--end::Wrapper-->
                </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="createTeam">
                    ...
                    <button type="submit" class="btn btn-primary">Assign team to mshahi.biz@gmail.com (Manish Shahi)</button>
                </form>
                <!--begin::Alert-->
                <div class="alert alert-primary d-flex align-items-center p-5  mt-4">
                    <!--begin::Icon-->
                    ...
                    <div class="d-flex flex-column">
                        <!--begin::Title-->
                        <h4 class="mb-1 text-success">mshahi.biz@gmail.com (Manish Shahi) has been added successfully to <b>Content Team</b>.</h4>
                        <!--end::Title-->
...
$(document).ready(function() {
    $(".commentFormBtn").on("click", function(e) {
        ...
        $.ajax({
            url: "sec_api/v1/create_post_comment",
            type: "POST",
            dataType: "json",
            data: {
                post_id: postId,
...
<!-- dont' delete below div -->
<?php end_html(['logout'], true, false, $js); ?>